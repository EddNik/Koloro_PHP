...
<div class="container">
    ...
    <div class="span10 offset1">
        <div class="row">
            <h4>Редактировать данные проекта</h4>
        </div>
        <form class="form-horizontal" action="../../controller/projectsController/update.php" method="post">
            ...
            <div class="control-group <?php echo !empty($startDateError) ? 'error' : ''; ?>">
                ...
                <div class="controls">
                    <input name="startDate" type="text" placeholder="startDate"
                           value="<?php echo !empty($startDate) ? $startDate : date(time()); ?>">
            ...
            <div class="control-group <?php echo !empty($endDateError) ? 'error' : ''; ?>">
                ...
                <div class="controls">
                    <input name="endDate" type="text" placeholder="endDate"
                           value="<?php echo !empty($endDate) ? $endDate : date(time()); ?>">
